# -*- coding: utf-8 -*-
# Generated by Django 1.11.29 on 2020-08-19 12:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='awwwwards.Countries')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='awwwwards.Post')),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='awwwwards.Profile')),
            ],
        ),
        migrations.CreateModel(
            name='Technologies',
        ...
        migrations.AddField(
            model_name='post',
            name='technologies',
            field=models.ManyToManyField(max_length=255, to='awwwwards.Technologies'),
        ),
        migrations.AddField(
            model_name='post',
            name='username',
