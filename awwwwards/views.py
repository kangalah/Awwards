...
def updateprofile(request):
    ...
    if request.method == 'POST':
        ...
        form = ProfileForm()
    return render(request, 'awards/profile_update.html',{"form":form })
...
def new_post(request):
        ...
        if request.method == 'POST':
                ...
                form = PostForm()
                return render(request,'awards/new_post.html', {"form":form})
...
def vote(request,post_id):
    try:
        ...
        raise Http404()
    return render(request,"awards/vote.html", {"post":post})
...
def search_results(request):
    ...
    if 'post' in request.GET and request.GET["post"]:
        ...
        return render(request, 'awards/search.html',{"message":message,"posts": searched_posts})
